...
def write_ply(fn, verts, colors, verts2, colors2):
    ply = '''ply
    format ascii 1.0
...
def reconstruction3D(imgLeft, imgRight, imgFront, imgBack, out_ply):
    ...
    write_ply(out_ply, out_points_3D, out_colors, out_points_3D2, out_colors2)
